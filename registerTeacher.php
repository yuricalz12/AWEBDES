              ...
              if ($result->num_rows > 0) {
                ...
                if($_POST['password'] != $_POST['confirmPassword']){
                  ...
                  if($stmt->execute()){
                     ...
                     if($stmt2->execute()){
                         echo "<div class='alert alert-success alert-dismissible' role='alert' ><strong>Teacher successfuly added<button type='button' class='close' data-dismiss='alert' aria-label='close'><span aria-hidden='true'>&times;</span></button></div>";
                     }
                  }
                }
              } 
