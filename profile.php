        ...
        <div class="container-fluid">
          ...
          <div class="row">
           ...
           <div class="row">
              ...
              <div class="col-md-3">
                <label><?php echo $info['first_name'] ?></label>
              </div>
           </div>
           <div class="row">
              <div class="col-md-2">
              ...
              <div class="col-md-3">
                <label><?php echo $info['last_name'] ?></label>
              </div>
           </div>
           <div class="row">
              <div class="col-md-2">
              ...
              <div class="col-md-3">
                <label><?php echo $info['address'] ?></label>
              </div>
           </div>
           <div class="row">
              <div class="col-md-2">
              ...
              <div class="col-md-3">
                <label><?php echo $info['gender'] ?></label>
              </div>
           </div>
           <div class="row">
              <div class="col-md-2">
